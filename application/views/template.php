			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="<?= base_url() ?>index.php/Histori"><i class="lnr lnr-linearicons"></i> <span>Histori Transaksi</span></a></li>
					
					<!-- Perbedaan saat level user -->
						<!-- kasir -->
						<?php if($this->session->userdata('level')=="kasir"){?>
						<li><a href="<?= base_url() ?>index.php/Transaksi" ><i class="fa fa-shopping-cart"></i> <span>Transaksi</span></a></li>
						<?php }?>
						<!-- admin -->
